...
Route::group([
    ...
    Route::get('projects/{project}/deployments', 'IndexController')->name('projects.deployments.index')->middleware('response_json.if_requested_by_query');
    ...
    Route::get('projects/{project}/deployments/{deployment}', 'ShowController')->name('projects.deployments.show')->middleware('response_json.if_requested_by_query');
});
