...
Route::group([
    ...
    Route::get('projects/{project}/deployments', 'IndexController')->middleware('response_json.if_requested_by_query')->name('projects.deployments.index');
    ...
    Route::get('projects/{project}/deployments/{deployment}', 'ShowController')->middleware('response_json.if_requested_by_query')->name('projects.deployments.show');
});
