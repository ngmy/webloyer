...
class DeployerProgressedSubscriber implements DomainEventSubscriber
{
    ...
    public function handle(DomainEvent $domainEvent): void
    {
        ...
        $deployment->appendLog($domainEvent->log());
    ...
    {
        return $domainEvent instanceof DeployerProgressed;
    }
}
