        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['route' => ['recipes.update', $recipe->recipeId()->id()], 'method' => 'put', 'role' => 'form','class' => 'form-horizontal']) !!}
                        ...
                        {!! Form::hidden('concurrency_version', $recipe->concurrencyVersion(), ['id' => 'concurrency_version']) !!}
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
