        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['route' => ['projects.update', $project->projectId()->id()], 'method' => 'put', 'role' => 'form','class' => 'form-horizontal']) !!}
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('server_id', $servers, $project->serverId()->id(), ['class' => 'form-control', 'id' => 'server_id']) !!}
                            </div>
                        </div>
                        <div class="form-group required">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('deploy_path', $project->attribute()->deployPath(), ['class' => 'form-control', 'id' => 'deploy_path']) !!}
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('days_to_keep_deployments', $project->daysToKeepDeployments(), ['class' => 'form-control', 'id' => 'days_to_keep_deployments']) !!}
                            </div>
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox">
                                    <label class"col-md-4">
                                        {!! Form::checkbox('keep_last_deployment', $project->keepLastDeployment()->value(), $project->keepLastDeployment()->value()) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('max_number_of_deployments_to_keep', $project->maxNumberOfDeploymentsToKeep(), ['class' => 'form-control', 'id' => 'max_number_of_deployments_to_keep']) !!}
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('github_webhook_user_id', $users, $project->githubWebhookExecuteUserId()->id(), ['class' => 'form-control', 'id' => 'github_webhook_user_id']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                        ...
                        {!! Form::hidden('concurrency_version', $project->concurrencyVersion(), ['id' => 'concurrency_version']) !!}
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
